...
| Метрика | Описание |
|---------|----------|
| H (Shannon Entropy) | Информационная энтропия распределения букв (бит) |
...
1. **Корреляция H vs N (slope)** ⭐⭐⭐⭐⭐ - главный показатель различия стилей
2. **Perplexity** ⭐⭐⭐⭐⭐ - эффективное число категорий (2^H)
3. **Evenness** ⭐⭐⭐⭐ - характеристика сбалансированности
4. **Спектр Реньи** ⭐⭐⭐⭐ - детальная картина распределения
5. **Alphabet Utilization** ⭐⭐⭐⭐ - широта использования языка

**Подробное руководство:** см. `AUTHOR_COMPARISON_GUIDE.md`
